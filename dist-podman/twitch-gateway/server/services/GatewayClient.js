...
export class GatewayClient {
    ...
    connect() {
        ...
        this.ws.on('message', (data) => {
            try {
                ...
                logger.addLog('error', 'Invalid WS Message', e, 'GatewayClient');
            }
        });
    ...
    async handlePayload(payload) {
        try {
            ...
            if (type === 'CHANNEL_SYNC') {
                ...
                if (action === 'upsert') {
                    try {
                        ...
                        logger.addLog('error', `Sync Upsert Failed (${channelId})`, e, 'GatewayClient');
                    ...
                    try {
                        ...
                        logger.addLog('error', `Sync Delete Failed (${channelId})`, e, 'GatewayClient');
            ...
            logger.addLog('error', 'Handle Payload Error', e, 'GatewayClient');
        }
    }
    ...
    handleChatMessage(event) {
        try {
            ...
            logger.addLog('error', 'Chat Message Handling Error', e, 'GatewayClient');
        }
    }
